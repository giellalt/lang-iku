...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_iku to login script."
...
# the current dir:
if   test x${GTLANG_iku} = x ; then
	echo "WARNING: The variable \${GTLANG_iku} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_iku} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_iku} has the value:"
	echo "  ${GTLANG_iku}"
