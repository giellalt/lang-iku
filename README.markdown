...
This directory contains source files for the Inuktitut language
...
-   <https://giellalt.uit.no/lang/iku/index.html> (analyser)
...
The Inuktitut language sources can be acquired using [giella SVN
